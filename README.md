...
- **Step 3:** If it is used in the API server, you will also need to define the environment variable in `apiserver/main/config.py` and `.github/workflows/lint-and-test.yaml`.
